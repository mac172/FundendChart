...
export default function LoginButton({
  ...
  return (
    <div className="min-h-12 w-48">
      <button
        className={cn(
          "group flex h-12 w-40 items-center justify-center gap-3 rounded-md bg-amber-100 p-2 font-bold transition-colors duration-100 ease-in-out hover:bg-orange-600",
          className,
        )}
      >
        <span
          className={cn(
            "text-black transition-colors duration-100 ease-in-out group-hover:text-amber-100",
          )}
        >
          {text}
        </span>
